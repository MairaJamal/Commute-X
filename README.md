...
- **Smart Matching** – Connects users with overlapping routes and schedules  
- **In‑App Chat** – Coordinate pickup points and timing  
...
### Installation
```bash
git clone https://github.com/MairaJamal/Commute-X.git
cd commute-x
npm install
npm run dev
